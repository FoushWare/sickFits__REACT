...
var Pagination_Pagination = function Pagination(props) {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    var data = _ref.data,
        ...
        error = _ref.error;
    if (loading) return external_react_default.a.createElement("p", null, "Loading..."); // console.log(data);
    ...
    }, "\u2190 Prev")), external_react_default.a.createElement("p", null, "Page ", props.page, " of ", pages, "!"), external_react_default.a.createElement("p", null, count, " Items Total"), external_react_default.a.createElement(link_default.a, {
      prefetch: true,
      href: {
        pathname: 'items',
        query: {
