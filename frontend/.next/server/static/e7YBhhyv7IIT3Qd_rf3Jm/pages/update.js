...
var UPDATE_ITEM_MUTATION = external_graphql_tag_default()(_templateObject());
var SINGLE_ITEM_QUERY = external_graphql_tag_default()(_templateObject2());
  ...
  _createClass(UpdateItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (!data.item) return external_react_default.a.createElement("p", null, "NO Item Found for ID ", id);
