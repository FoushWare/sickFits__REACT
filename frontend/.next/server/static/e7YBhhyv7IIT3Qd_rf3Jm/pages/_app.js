...
var SIGNOUT_MUTATION = external_graphql_tag_default()(_templateObject());
...
var external_react_transition_group_ = __webpack_require__(21);

// CONCATENATED MODULE: ./components/CartCout.js
...
var CartCout_CartCount = function CartCount(_ref) {
...
/* harmony default export */ var CartCout = (CartCout_CartCount);
...
var Nav_Nav = function Nav() {
  return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
    ...
    return external_react_default.a.createElement(styles_NavStyles, null, external_react_default.a.createElement(link_default.a, {
      ...
      return external_react_default.a.createElement("button", {
        onClick: toggleCart
      }, "My Cart", external_react_default.a.createElement(CartCout, {
...
function (_Component) {
  ...
  function AutoComplete() {
    ...
    Search_defineProperty(Search_assertThisInitialized(Search_assertThisInitialized(_this)), "routeToItem", function (item) {
      router_default.a.push({
        pathname: '/item',
        query: {
          id: item.id
...
function (_Component) {
  ...
  function Page() {
    ...
    Page_defineProperty(Page_assertThisInitialized(Page_assertThisInitialized(_this)), "state", {});
